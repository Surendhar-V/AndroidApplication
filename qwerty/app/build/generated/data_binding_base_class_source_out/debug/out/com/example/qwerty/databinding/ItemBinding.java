...
import com.example.qwerty.interfaces.ItemInterface;
...
public abstract class ItemBinding extends ViewDataBinding {
  ...
  @Bindable
  protected ItemInterface mItemInterface;

  protected ItemBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CardView cardView, ImageView img, TextView name, TextView oldPrice, TextView price) {
  ...
  public abstract void setItemInterface(@Nullable ItemInterface itemInterface);

  @Nullable
  public ItemInterface getItemInterface() {
    return mItemInterface;
  }
