...
public class ItemBindingImpl extends ItemBinding implements com.example.qwerty.generated.callback.OnClickListener.Listener {
    ...
    private ItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.example.qwerty.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            ...
            setItemInterface((com.example.qwerty.interfaces.ItemInterface) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemInterface(@Nullable com.example.qwerty.interfaces.ItemInterface ItemInterface) {
    ...
    protected void executeBindings() {
        ...
        com.example.qwerty.interfaces.ItemInterface itemInterface = mItemInterface;
